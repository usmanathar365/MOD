                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-12">
                      <div class="pop-field-input">
                        ...
                        <span id="role_err" class="text-danger laravel_validation"> </span>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 ">
                      ...
                      <div class="pop-field-input">
                        ...
                        <span id="password_err" class="text-danger laravel_validation"> </span>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 ">
                      <div class="pop-field-input">
                        ...
                        <span id="confirm_password_err" class="text-danger laravel_validation"> </span>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  function View(id) {
    var columns = ['created_at', 'name', 'email', 'password'];
            ...
            if (key[0] == "logo") {
              $('#modalViewBody').append(`
                <div class="col-12 col-sm-12">
                    ...
                    <div class="view-img"> 
                    <img  src='{{URL("/public/uploads/users");}}/${key[1]}'
                    </div>
                  </div>
                  `);
  ...
  function UpdatePassword() {
    ...
    $.ajax(settings).done(function(response) {
      if (response.status == false) {
        ...
        $("input[name=id]").val('');
        $('#createModal').modal('hide');
        swal("Password Updated Successfully!", response.message, "success");
        $('#listTable').DataTable().ajax.reload();
      }
